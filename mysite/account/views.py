...
def register(request):
	if request.method == "POST":
		...
		print('user_form:{}, {}'.format(user_form, user_form.is_valid()))
		print('userprofile_form: {},{}'.format(userprofile_form, userprofile_form.is_valid()))
...
def myself_edit(request):
	...
	if request.method == "POST":
		...
		return render(request, "account/myself_edit.html", {"user_form":user_form, "userprofile_form": \
															userprofile_form, "userinfo_form": userinfo_form})
